...
Read [`here`](docs/specifications/12-quickstart.md) to get started with the quickstart guide. and [pre requirements](docs/specifications/11-pre-required-env-values.md) may help you get started.
